...
class FeatureExtractor:
    ...
    def _build_detection_model(self):
        ...
        checkpoint = torch.load('C:/Users/multicampus/Desktop/checkpoints/detectron_model.pth',
...
class Caption_Model:
    ...
    def load_model(self):
        ...
        infos = captioning.utils.misc.pickle_load(
            open('C:/Users/multicampus/Desktop/checkpoints/infos_trans12-best.pkl', 'rb'))
        infos['opt'].vocab = infos['vocab']

        self.model = captioning.models.setup(infos['opt'])
        self.model.cuda()
        self.model.load_state_dict(torch.load(
            'C:/Users/multicampus/Desktop/checkpoints/model-best.pth'))
...
if __name__ == '__main__':
    ...
    # Caption_Model 의 inference 함수로 캡션 얻고 출력
